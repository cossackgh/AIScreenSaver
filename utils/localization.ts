...
export const translations = {
  en: {
    ...
    weatherApiKeyHint: 'Get your free API key at openweathermap.org',
    weatherCities: 'Weather Cities',
    addCity: 'Add City',
    removeCity: 'Remove',
    currentCity: 'Current City',
    enterCityName: 'Enter city name',
    maxCitiesReached: 'Maximum 5 cities allowed',
    ...
    imageDisplayOrder: 'Display Order',
  ...
  ru: {
    ...
    weatherApiKeyHint: 'Получите бесплатный API ключ на openweathermap.org',
    weatherCities: 'Города для погоды',
    addCity: 'Добавить город',
    removeCity: 'Удалить',
    currentCity: 'Текущий город',
    enterCityName: 'Введите название города',
    maxCitiesReached: 'Максимум 5 городов',
    ...
    imageDisplayOrder: 'Порядок отображения',
